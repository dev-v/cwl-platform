package com.dber.platform.util;

import javax.sql.DataSource;

import com.dber.tool.config.DbType;
import com.dber.tool.config.JdbcPoolConfig;
...
public class DBUtil {
  ...
  public static final DataSource dataSource(JdbcPoolConfig config) {
    ...
    DataSource dataSource = getDruidSource(url, config);
    try {
      dataSource.setLoginTimeout(config.getLoginTimeOut());
